...
function Diferencial() {
    return (
        <section className="diferencial-home">
            <TiposCard img={velocidade} titulo="Velocidade no Preparo" texto="
Na Comidaria Express, destacamos a rapidez na preparação de refeições deliciosas, mantendo a qualidade. Experimente a conveniência sem abrir mão do sabor." />
